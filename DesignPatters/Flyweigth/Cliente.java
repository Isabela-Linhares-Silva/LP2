...
public class Cliente {
    private static final String cores[]={"Vermelho","Verde","Preto","Azul","Branco"};

    public static void main(String[] args) {
        FabricaDeCirculos fabrica = new FabricaDeCirculos();

        for (int i = 0; i < 20; i++) {
            Circulo c = fabrica.getCirculo(getCorAleatoria());
            c.desenhar(getXAleatorio(), getYAleatorio(), getRaioAleatorio());
